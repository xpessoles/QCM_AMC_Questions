...
%J_1 \dfrac{Z_2}{Z_1}^2 + J_2  + J_3 \dfrac{Z_2}{N}^2

%\begin{multicols}{2}
	\begin{reponses}
	\bonne     {$J_1\left(\dfrac{Z_2}{Z_1}\right)^2  + J_2   + J_3 \left(\dfrac{Z_2}{N}\right)^2$}	
	\mauvaise {$J_1\left(\dfrac{Z_2}{Z_1}\right)^2  + J_2   + J_3 \left(\dfrac{Z_1}{N}\right)^2$}	
	\mauvaise {$J_1\left(\dfrac{Z_1}{Z_2}\right)^2   + J_2  + J_3 \left(\dfrac{Z_2}{N}\right)^2$}	
...
%\begin{multicols}{2}
	\begin{reponses}	
           ...
           \mauvaise      {$ J_1\left(\dfrac{2\pi Z_2}{ Z_1 p}\right)^2 + J_2\left(\dfrac{  p}{ 2\pi } \right)^2 + M $}
  	\end{reponses}
%\end{multicols}
\end{question}\\}
